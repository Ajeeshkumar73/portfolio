    ...
    <>
      ...
      >
        <div class="md:col-span-5 flex flex-col gap-6">
          ...
          {/* Direct Contact Info - Edit email and WhatsApp below */}
          <div className="flex flex-col gap-4 my-2">
            ...
            >
              <span className="w-10 h-10 rounded-full border border-outline/20 flex items-center justify-center bg-surface-container hover:bg-primary/10 transition-colors">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                  <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                </svg>
              </span>
              <span className="font-body-md font-medium">ajeeshkumarbs168@gmail.com</span>
            </a>
            ...
            >
              ...
              <span className="font-body-md font-medium">YOUR_WHATSAPP_NUMBER</span>
            </a>
          </div>
